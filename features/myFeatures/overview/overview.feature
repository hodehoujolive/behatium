...
Feature: overview
  ...
  Scenario: overview
    ...
    And I click link with href "/docs/4.4/components/alerts/"
    And I click link with href "/docs/4.4/components/buttons/"
    And I click button with type "button" and class "btn btn-primary"
    And I click link with href "/docs/4.4/components/forms/"
